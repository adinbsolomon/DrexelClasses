...
public class KWICCircularShifter extends KWICWorker {

	public KWICCircularShifter(KWICMediator mediator) {
		super(mediator);
	}
	...
	public void shiftLine(String line) {
		...
		for (int i = 0; i < currentTokens.size(); i++) {
			...
			this.mediator.shifterHasNewLine(String.join(" ", currentTokens));
		}
	}
